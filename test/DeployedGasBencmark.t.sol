...
contract DeployedGasBenchmark is Test {
    ...
    function testAddLiquidityGasComparison() public {
        ...
        basicAmm.addLiquidity(
            LIQUIDITY_AMOUNT, LIQUIDITY_AMOUNT, LIQUIDITY_AMOUNT * 95 / 100, LIQUIDITY_AMOUNT * 95 / 100, alice
        );
        uint256 basicGas = gasStart - gasleft();
    ...
    function _reportGasComparison(string memory operation, uint256 basicGas, uint256 blendedGas) internal pure {
        console.log("\n", operation, "Results:");
